...
<html>
	...
	<body>
		<?php
			...
			$sql = "SELECT DISTINCT(name), phone, score, save FROM scores WHERE score >= 26 ORDER BY score DESC LIMIT 27";
			$result = $conn->query($sql);
				echo "<p class='display-3'>คะแนนปริศนาทายภาพ</p>";
